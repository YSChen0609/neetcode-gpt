...
# Use torch.round(out=<input_tensor>) to do inplace replacement to save memory
class Solution:
    ...
    def get_loss(self, prediction: TensorType[float], target: TensorType[float]) -> TensorType[float]:
        ...
        return torch.round(mse_loss, decimals=4, out=mse_loss)
